...
Run the **main processing script** to compute the Spherical Harmonic coefficients for all variables ($N_e$, RODI, $\gamma$). This step generates the .pkl model files used for inference. This run may take several minutes. Enjoy a coffe !
